---
title: "Deciding the un-correlated tissues used in multi-tissue analysis"
author: "XSun"
date: "2023-12-13"
output:
...
## Used in deciding the uncorrelated tissues

Tissue-tissue correlation data are from [MASH paper, PMID30478440](https://www.nature.com/articles/s41588-018-0268-8)
...
tissue_select <- c("Artery_Coronary","Artery_Tibial","Heart_Atrial_Appendage", "Heart_Left_Ventricle", "Kidney_Cortex", "Liver", "Lung", "Pancreas", "Whole_Blood")

print(sprintf("%s was not included in MESH",paste0(tissue_select[!tissue_select%in%rownames(lat)], collapse = ", ")))
...
DT::datatable(sum_cat,caption = htmltools::tags$caption( style = 'caption-side: topleft; text-align = left; color:black;  font-size:150% ;','summary for ctwas parameters and high pip genes'),options = list(pageLength = 5) )
